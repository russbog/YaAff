...
{
    $items = [
        ['key' => 'campaigns',    'label' => 'Campaigns',     'icon' => 'megaphone',   'perm' => 'campaigns.view',     'group' => 'Traffic'],
        ['key' => 'domains',      'label' => 'Domains',       'icon' => 'globe',       'perm' => 'domains.view',       'group' => 'Traffic'],
        ['key' => 'dashboard',    'label' => 'Dashboard',     'icon' => 'gauge',       'perm' => 'reports.view',       'group' => 'Analytics'],
        ['key' => 'reports',      'label' => 'Reports',       'icon' => 'table',       'perm' => 'campaigns.view',     'group' => 'Analytics'],
        ['key' => 'trends',       'label' => 'Trends',        'icon' => 'trend',       'perm' => 'reports.view',       'group' => 'Analytics'],
        ['key' => 'conversions',  'label' => 'Conversions',   'icon' => 'trend',       'perm' => 'conversions.view',   'group' => 'Analytics'],
        ['key' => 'offers',       'label' => 'Offers',        'icon' => 'target',      'perm' => 'offers.view',        'group' => 'Catalog'],
        ['key' => 'landings',     'label' => 'Landings',      'icon' => 'file',        'perm' => 'landings.view',      'group' => 'Catalog'],
        ['key' => 'sources',      'label' => 'Sources',       'icon' => 'broadcast',   'perm' => 'sources.view',       'group' => 'Catalog'],
        ['key' => 'networks',     'label' => 'Networks',      'icon' => 'sitemap',     'perm' => 'networks.view',      'group' => 'Catalog'],
        ['key' => 'integrations', 'label' => 'Conversion APIs', 'icon' => 'cloud',     'perm' => 'integrations.view',  'group' => 'Automation'],
        ['key' => 'blacklists',   'label' => 'Bot Protection', 'icon' => 'shield',     'perm' => 'blacklists.view',    'group' => 'Automation'],
        ['key' => 'rules',        'label' => 'Rules',         'icon' => 'robot',       'perm' => 'rules.view',         'group' => 'Automation'],
        ['key' => 'channels',     'label' => 'Notifications', 'icon' => 'bell',        'perm' => 'channels.view',      'group' => 'Automation'],
        ['key' => 'users',        'label' => 'Users',         'icon' => 'users',       'perm' => 'users.view',         'group' => 'Administration'],
        ['key' => 'roles',        'label' => 'Roles',         'icon' => 'badge',       'perm' => 'roles.view',         'group' => 'Administration'],
        ['key' => 'data',         'label' => 'Data',          'icon' => 'database',    'perm' => 'data.view',          'group' => 'Administration'],
        ['key' => 'api',          'label' => 'REST API',      'icon' => 'braces',      'perm' => null,                 'group' => 'Administration'],
    ];
