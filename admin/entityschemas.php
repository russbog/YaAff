    ...
    $schemas = [
        ...
        'offers' => [
            ...
            'fields' => [
                ...
                ['key' => 'url', 'label' => 'Target URL', 'type' => 'text', 'section' => 'Destination', 'placeholder' => 'https://offer.com/{some_param}?clickid={clickid}', 'help' => 'Where the click is sent. An offer is always a redirect link. Tokens (path and query) are substituted live: any param you pass to the campaign link is available by name (e.g. {some_param}), and unknown tokens are dropped to empty.', 'tokens' => $urlTokens],
                ['key' => 'redirect_type', 'label' => 'Redirect type', 'type' => 'select', 'options' => $redirectTypes, 'default' => 'http_302', 'section' => 'Destination'],
